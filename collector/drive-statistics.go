...
func NewDriveStatisticsExporter(target config.Target, logger log.Logger, useCache bool) Collector {
	return &DriveStatisticsCollector{
		AverageReadOpSize: prometheus.NewDesc(prometheus.BuildFQName(namespace, "drive", "average_read_op_size"),
			"Drive statistic averageReadOpSize", []string{"tray", "slot"}, nil),
		AverageWriteOpSize: prometheus.NewDesc(prometheus.BuildFQName(namespace, "drive", "average_write_op_size"),
		...
		CombinedResponseTime: prometheus.NewDesc(prometheus.BuildFQName(namespace, "drive", "combined_response_time"),
			"Drive statistic combinedResponseTime", []string{"tray", "slot"}, nil),
		CombinedThroughput: prometheus.NewDesc(prometheus.BuildFQName(namespace, "drive", "combined_throughput"),
		...
		ReadResponseTime: prometheus.NewDesc(prometheus.BuildFQName(namespace, "drive", "read_response_time"),
			"Drive statistic readResponseTime", []string{"tray", "slot"}, nil),
		ReadThroughput: prometheus.NewDesc(prometheus.BuildFQName(namespace, "drive", "read_throughput"),
			"Drive statistic combinedThroughput", []string{"tray", "slot"}, nil),
		...
		WriteResponseTime: prometheus.NewDesc(prometheus.BuildFQName(namespace, "drive", "write_response_time"),
			"Drive statistic writeResponseTime", []string{"tray", "slot"}, nil),
		WriteThroughput: prometheus.NewDesc(prometheus.BuildFQName(namespace, "drive", "write_throughput"),
			"Drive statistic combinedThroughput", []string{"tray", "slot"}, nil),
		target:   target,
		logger:   logger,
		useCache: useCache,
