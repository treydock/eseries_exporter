...
func NewDriveStatisticsExporter(target config.Target, logger log.Logger) Collector {
	return &DriveStatisticsCollector{
		...
		IdleTime: prometheus.NewDesc(prometheus.BuildFQName(namespace, "drive", "idle_time_total"),
		...
		OtherTimeTotal: prometheus.NewDesc(prometheus.BuildFQName(namespace, "drive", "other_time_total"),
		...
		ReadTimeTotal: prometheus.NewDesc(prometheus.BuildFQName(namespace, "drive", "read_time_total"),
		...
		WriteTimeTotal: prometheus.NewDesc(prometheus.BuildFQName(namespace, "drive", "write_time_total"),
