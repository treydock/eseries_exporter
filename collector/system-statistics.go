...
func NewSystemStatisticsExporter(target config.Target, logger log.Logger, useCache bool) Collector {
	return &SystemStatisticsCollector{
		AverageReadOpSize: prometheus.NewDesc(prometheus.BuildFQName(namespace, "system", "average_read_op_size"),
			"System statistic averageReadOpSize", []string{"id"}, nil),
		AverageWriteOpSize: prometheus.NewDesc(prometheus.BuildFQName(namespace, "system", "average_write_op_size"),
		...
		CombinedHitResponseTime: prometheus.NewDesc(prometheus.BuildFQName(namespace, "system", "combined_hit_response_time"),
		...
		CombinedResponseTime: prometheus.NewDesc(prometheus.BuildFQName(namespace, "system", "combined_response_time"),
			"System statistic combinedResponseTime", []string{"id"}, nil),
		CombinedThroughput: prometheus.NewDesc(prometheus.BuildFQName(namespace, "system", "combined_throughput"),
		...
		ReadHitResponseTime: prometheus.NewDesc(prometheus.BuildFQName(namespace, "system", "read_hit_response_time"),
		...
		ReadResponseTime: prometheus.NewDesc(prometheus.BuildFQName(namespace, "system", "read_response_time"),
			"System statistic readResponseTime", []string{"id"}, nil),
		ReadThroughput: prometheus.NewDesc(prometheus.BuildFQName(namespace, "system", "read_throughput"),
			"System statistic combinedThroughput", []string{"id"}, nil),
		WriteHitResponseTime: prometheus.NewDesc(prometheus.BuildFQName(namespace, "system", "write_hit_response_time"),
		...
		WriteResponseTime: prometheus.NewDesc(prometheus.BuildFQName(namespace, "system", "write_response_time"),
			"System statistic writeResponseTime", []string{"id"}, nil),
		WriteThroughput: prometheus.NewDesc(prometheus.BuildFQName(namespace, "system", "write_throughput"),
			"System statistic combinedThroughput", []string{"id"}, nil),
		target:   target,
		logger:   logger,
		useCache: useCache,
